...
# Generated by qmake (2.01a) (Qt 4.8.6) on: Thu Apr 24 19:49:08 2014
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/simponopoly1.0.0/ && $(COPY_FILE) --parents Action.h Bank.h Card.h CardAction.h CentralWidget.h ConsoleWidget.h Deck.h Die.h Game_Board.h GoToAction.h GUIChestSpace.h GUIPlayer.h GUIPropertySpace.h GUISpace.h IconDialog.h MainWindow.h MoneyAction.h MoveAction.h Player.h PlayerDock.h PropertyAction.h Space.h .tmp/simponopoly1.0.0/ && $(COPY_FILE) --parents application.qrc .tmp/simponopoly1.0.0/ && $(COPY_FILE) --parents Action.cpp Bank.cpp Card.cpp CardAction.cpp CentralWidget.cpp ConsoleWidget.cpp Deck.cpp Die.cpp Game_Board.cpp GoToAction.cpp GUIChestSpace.cpp GUIPlayer.cpp GUIPropertySpace.cpp GUISpace.cpp IconDialog.cpp main.cpp MainWindow.cpp MoneyAction.cpp MoveAction.cpp Player.cpp PlayerDock.cpp PropertyAction.cpp Space.cpp .tmp/simponopoly1.0.0/ && (cd `dirname .tmp/simponopoly1.0.0` && $(TAR) simponopoly1.0.0.tar simponopoly1.0.0 && $(COMPRESS) simponopoly1.0.0.tar) && $(MOVE) `dirname .tmp/simponopoly1.0.0`/simponopoly1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/simponopoly1.0.0
