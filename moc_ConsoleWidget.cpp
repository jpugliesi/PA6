...
static const char qt_meta_stringdata_ConsoleWidget[] = {
    "ConsoleWidget\0buyProperty()\0\0"
    "sellPropertyToBank()\0sellPropertyToPlayer()\0"
    "upgradeProperty()\0rollDice()\0"
};
...
void ConsoleWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->buyProperty(); break;
        case 1: _t->sellPropertyToBank(); break;
        case 2: _t->sellPropertyToPlayer(); break;
        case 3: _t->upgradeProperty(); break;
        case 4: _t->rollDice(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
